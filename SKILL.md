...
**Mode B, Historical fold.** A *time window* of already-closed sessions (e.g. "back to May 20"). Sessions can't be probed, since they're closed, so **compress each from its transcript** instead of probing:
